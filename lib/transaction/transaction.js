 ...
 * and a slightly fancier format recognized by btcjs:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a btcjs Address object. The
 * same is true for `script`, which can be a string or a btcjs Script.
 *
