 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`btc.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`btc.min.js`)
...
var buildPath = './';
var buildModulesPath = './node_modules/';
...
if (browser) {
  ...
  browserifyCommand = buildBinPath + 'browserify --require ./index.js:btcjs -o btc.js';
